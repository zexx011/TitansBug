...
bot.command("colong", async (ctx) => {
  ...
  if (input.length < 3)
    return ctx.reply(
      "Format salah\nContoh: /coling http://domain.com plta_xxxx pltc_xxxx"
    );
...
<div class="quick-actions">
  ...
  <button onclick="showSection('tracking-section')">
    ...
    <section id="bug-section" class="content-section active">
      <div class="box">
        <img src="https://files.catbox.moe/xx09jo.jpg" class="logo" alt="Overload-X Logo">
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if(['owner','reseller','admin'].includes(role)) {
